...
#pragma mark -
#define BUGLY_LOG_MACRO(_level, format, ...) [BuglyLog level:_level tag:nil log:format, ##__VA_ARGS__]

#define BLYLogError(format, ...)   BUGLY_LOG_MACRO(BuglyLogLevelError, format, ##__VA_ARGS__)
#define BLYLogWarn(format, ...)    BUGLY_LOG_MACRO(BuglyLogLevelWarn,  format, ##__VA_ARGS__)
#define BLYLogInfo(format, ...)    BUGLY_LOG_MACRO(BuglyLogLevelInfo, format, ##__VA_ARGS__)
#define BLYLogDebug(format, ...)   BUGLY_LOG_MACRO(BuglyLogLevelDebug, format, ##__VA_ARGS__)
#define BLYLogVerbose(format, ...) BUGLY_LOG_MACRO(BuglyLogLevelVerbose, format, ##__VA_ARGS__)
