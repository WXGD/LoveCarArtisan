...
- (void)setOrderModel:(OrderModel *)orderModel {
    ...
    /** 订单名称 */
    self.orderCellView.orderNameLabel.text = orderModel.goods_name;
    /** 订单时间 */
    ...
    /** 订单价格 */
    self.orderCellView.orderPriceLabel.text = [NSString stringWithFormat:@"%.2f元", orderModel.sale_price];
    /** 订单次数 */
    self.orderCellView.orderNumLabel.text = [NSString stringWithFormat:@"x%ld", (long)orderModel.buy_num];
    /** 合计 */
